...
const AdmissionDetails = () => {
    ...
    return (
        <div className="hero min-h-screen" style={{ backgroundImage: `url(${colleges.college_image})` }}>
                ...
                <div className="max-w-md">
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="hero-content text-center text-black">
                            <div className="form-control">
                                <label className="label">
                                    <span className="label-text text-white text-lg">Candidate Name</span>
                                </label>
                                <input type="text" name='name' placeholder="name" className="input input-bordered" />
                            </div>
                            <div className="form-control">
                                <label className="label">
                                    <span className="label-text text-white text-lg">Candidate Email</span>
                                </label>
                                <input defaultValue={user.email} type="email" name='email' placeholder="email" className="input input-bordered" />
                            </div>
                        </div>
                        <div className="hero-content text-center text-black">
                            <div className="form-control">
                            ...
                            <div className="form-control">
                                <label className="label">
                                    <span className="label-text text-white text-lg">Phone Number</span>
                                </label>
                        ...
                        <div className="hero-content text-center text-black">
                            ...
                            <div className="form-control">
                                <label className="label">
                                    <span className="label-text text-white text-lg">Date Of Birth</span>
                                </label>
                                <input type="date" name='date' placeholder="date-of birth" className="input input-bordered w-full" />
                            </div>
                        </div>
                        <div className='text-black'>
                            <input type="text" name='image' placeholder="image" className="input input-bordered w-full" />
                        </div>
                        <input type="submit" value="Submit" className='btn w-full mt-3 bg-lime-300' />
                    </form>
                </div>
            </div>
        </div>
